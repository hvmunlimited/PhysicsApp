package dk.pless84.physics.convert;
...
public class ConvertActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		((TextView) findViewById(R.id.backgroundText)).setTypeface(font);
		((Button) findViewById(R.id.startButton)).setTypeface(font);
		((Button) findViewById(R.id.resetButton)).setTypeface(font);
		((Button) findViewById(R.id.stopButton)).setTypeface(font);
	}

	private void checkScreenDensity() {
		TextView tempTextView = (TextView) findViewById(R.id.backgroundText);
