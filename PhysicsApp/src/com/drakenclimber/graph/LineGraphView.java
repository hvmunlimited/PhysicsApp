...
public class LineGraphView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < verticalMarkers + 1; i++) {
            ...
            paint.setColor(dk.pless84.physics.R.color.offBlack);
        ...
        paint.setColor(dataSets.get(0).getColor());
        canvas.drawText("-X-", (graphWidth / 2) + horizontalStart -25, border - 4,
                paint);
        paint.setColor(dataSets.get(1).getColor());
        canvas.drawText("-Y-", (graphWidth / 2) + horizontalStart, border - 4,
                paint);
        paint.setColor(dataSets.get(2).getColor());
        canvas.drawText("-Z-", (graphWidth / 2) + horizontalStart + 25, border - 4,
                paint);
